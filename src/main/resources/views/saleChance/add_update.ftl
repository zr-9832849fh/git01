...
<form class="layui-form" style="width:80%;">
    ...
    <div class="layui-form-item layui-row layui-col-xs12">
        ...
        <div class="layui-input-block">
            <input type="text" class="layui-input" name="cgjl" placeholder="请输入成功几率" value="${(saleChance.cgjl)!}">
        </div>
    </div>
    <div class="layui-form-item layui-row layui-col-xs12">
    ...
    <div class="layui-form-item layui-row layui-col-xs12">
        <#--在弹出框中，指派人与销售人员对应（t_role角色表 和 t_user_role中间表 和t_sale_chance，拿到之后将数据放入下拉框option），-->
