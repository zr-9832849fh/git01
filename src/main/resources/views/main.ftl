...
<div class="layui-layout layui-layout-admin">
    ...
    <div class="layui-side layui-bg-black">
        <div class="layui-side-scroll layui-left-menu">
            <#--判断当前用户查出来的permission中是否有值; ?? 代表是否非空，返回布尔类型  ? 代表是否 后面加上关键字-->
                <#if permission??>
                <ul class="layui-nav layui-nav-tree layui-left-nav-tree layui-this" id="currency">
                        <#--通过freemarker中的seq_contains内建指令判断菜单是否显示-->
                        <#if permission?seq_contains("10")>   <#--营销管理10-->
                        <li class="layui-nav-item">
                            ...
                            <dl class="layui-nav-child">
                                    <#if permission?seq_contains("1010")>
                                    <dd>
                                        <a href="javascript:;" class="layui-menu-tips" data-type="tabAdd" data-tab-mpi="m-p-i-1" data-tab="sale_chance/index" target="_self"><i class="fa fa-tty"></i><span class="layui-left-nav"> 营销机会管理</span></a>
                                                                                                                               <#--data-tab 是到controller层下的index-->
                                    </dd>
                                    </#if>

                                    <#if permission?seq_contains("1020")>
                                    <dd>
                                    ...
                                    </dd>                                                                                      <#--data-tab 是到controller层下的index-->
                        ...
                        <#if permission?seq_contains("20")>   <#--客户管理20-->
                        <li class="layui-nav-item">
                            <a href="javascript:;" class="layui-menu-tips"><i class="fa fa-flag"></i><span class="layui-left-nav"> 客户管理</span> <span class="layui-nav-more"></span></a><dl class="layui-nav-child">
                                <#if permission?seq_contains("2010")>
                                <dd>
                                ...
                                <#if permission?seq_contains("2020")>
                                <dd>
                        ...
                        <#if permission?seq_contains("30")>   <#--服务管理30-->
                        <li class="layui-nav-item">
                            ...
                            <dl class="layui-nav-child">
                                <#if permission?seq_contains("3010")>
                                <dd>
                                ...
                                <#if permission?seq_contains("3020")>
                                <dd>
                                ...
                                <#if permission?seq_contains("3030")>
                                <dd>
                                ...
                                <#if permission?seq_contains("3040")>
                                <dd>
                                ...
                                <#if permission?seq_contains("3050")>
                                <dd>
                        ...
                        <#if permission?seq_contains("40")>   <#--统计报表40-->
                        <li class="layui-nav-item">
                            <a href="javascript:;" class="layui-menu-tips"><i class="fa fa-home"></i><span class="layui-left-nav"> 统计报表</span> <span class="layui-nav-more"></span></a><dl class="layui-nav-child">
                                <#if permission?seq_contains("4010")>
                                <dd>
                                ...
                                <#if permission?seq_contains("4020")>
                                <dd>
                                ...
                                <#if permission?seq_contains("4030")>
                                <dd>
                                ...
                                <#if permission?seq_contains("4040")>
                                <dd>
                        ...
                        <#if permission?seq_contains("60")>   <#--系统设置60-->
                        <li class="layui-nav-item">
                            ...
                            <dl class="layui-nav-child">
                                <#if permission?seq_contains("6010")>
                                <dd>
                                ...
                                <#if permission?seq_contains("6020")>
                                <dd>
                                ...
                                <#if permission?seq_contains("6030")>                                                                                                    <#--用于跳转到controller层-->
                                <dd class="">
                                ...
                                <#if permission?seq_contains("6040")>                                                                                   <#--用于跳转到controller层-->
                                <dd class="">
